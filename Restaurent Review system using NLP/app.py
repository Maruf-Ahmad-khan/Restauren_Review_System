...
html_temp = """
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">Computer Science And Engineering</p></center>  
   </div>
   </div>
   </div>
   """
...
if st.button("About"):
  st.subheader("Developed by Maruf khan")
  # st.subheader("Head , Department of Computer Engineering")
html_temp = """
   <div class="" style="background-color:orange;" >
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:20px;color:white;margin-top:10px;">Project deployed by Maruf khan</p></center> 
   </div>
   </div>
   </div>
   """
